...
```{r, eval = TRUE}
biomark_of_interest<-c("hsa-miR-214","PTEN","FOXO1","hsa-miR-27a","PEX7","hsa-miR-30a-5p","EPT1")
...
B<-matrix( c("Gene network", "Validated miRNA-target","","", "Predicted miRNA-target","","","", "Extracellular Circulating microRNAs", "miRNA-disease", "Drug Associations",
             ...
             "Current","N/A","miRwalk2","miRTarBase 7","DIANA- 5.0","N/A","N/A","TargetScan7.1","miRandola v 02/2017","N/A","N/A",
             2016,2009,2015,2017,2013,2010,"N/A","2016",2017,2009,"N/A",
